...
export const WorkerOrderDetailView: React.FC<WorkerOrderDetailViewProps> = ({ task, onBack, onRegisterProgress, onCloseVisit }) => {
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center">
              ...
              <div className="w-full max-w-[260px] space-y-3 mt-4">
                ...
                <button 
                  ...
                  className="w-full bg-slate-900 hover:bg-slate-800 text-white py-4 px-6 rounded-2xl font-bold text-sm shadow-md shadow-slate-900/20 flex items-center justify-center gap-2 active:scale-95 transition-all"
                >
                  <CheckCircle size={20} />
                  Cerrar Visita
                </button>
